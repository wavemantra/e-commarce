...
const userregistration = asyncHandler(async (req, res) => {
    ...
    try {
        if (
            [email, Name, password,phone].some((field) => field?.trim() === "")
        ) {
...
const updateAccountDetails = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, "Account Details Update successfully", user))
})
...
export {
    userregistration, loginuser, logoutuser, refreshAccessToken, ChangeCurrentPassword, getCurrentuser, updateAccountDetails, updateAvatar, deleteuser,getalluser
    //  totalcount
}